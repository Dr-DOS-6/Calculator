...
class main_win(func):
    def __init__(self):
        ...
        self.temp = str()
        mli[2] = 0
        self.conframe = tk.Frame(self.main_win,relief=tk.RAISED,bd=2, width=self.btnwid*4,height=self.btnhei*4)
        self.btnframe1 = tk.Frame(self.main_win,relief=tk.RAISED,bd=2, width=self.btnwid*4,height=self.btnhei)
        self.btnframe2 = ttk.Frame(self.main_win, width=self.btnwid*4,height=self.btnhei)
        self.btnframe3 = ttk.Frame(self.main_win, width=self.btnwid*4,height=self.btnhei)
        self.btnframe4 = ttk.Frame(self.main_win, width=self.btnwid*4,height=self.btnhei)
        self.btnframe5 = ttk.Frame(self.main_win, width=self.btnwid*4,height=self.btnhei)
        ...
        self.btnAst =  ttk.Button(self.btnframe1, text="x",style="stdButton.TButton")
        self.btnSl =   ttk.Button(self.btnframe1, text="÷",style="stdButton.TButton")
        self.btnEtr =  ttk.Button(self.main_win, text="Enter",style="stdButton.TButton",command=lambda: self.btnEnter())
        self.btnFn =   ttk.Button(self.btnframe1, text=f"切替",style="stdButton.TButton")
        self.btnBksp = ttk.Button(self.btnframe1,text="←",style="stdButton.TButton")
        ...
        self.console = ttk.Label(self.conframe,width=self.btnwid*4,relief="sunken",style="stdLabel.TLabel",anchor=tk.NW,textvariable=self.textoutput)
        self.conframe.pack(side=tk.TOP,expand=1)
        self.console.pack(fill=tk.BOTH,expand=1)#place(x=0,y=0,width=self.btnwid*4,height=self.btnhei*2)
        self.btnframe1.pack(side=tk.TOP,expand=1)
        self.btnFn.pack(side=tk.LEFT,expand=1)#lace(x=0,y=self.btnhei*2,width=self.btnwid,height=self.btnhei)
        self.btnSl.pack(expand=1)#lace(x=self.btnwid,y=self.btnhei*2,width=self.btnwid,height=self.btnhei)
        self.btnAst.pack(expand=1)#lace(x=self.btnwid*2,y=self.btnhei*2,width=self.btnwid,height=self.btnhei)
        self.btnBksp.pack(expand=1)#lace(x=self.btnwid*3,y=self.btnhei*2,width=self.btnwid,height=self.btnhei)
        self.btn7.place(x=0,y=self.btnhei*2+self.btnhei,width=self.btnwid,height=self.btnhei)
        self.btn8.place(x=self.btnwid,y=self.btnhei*2+self.btnhei,width=self.btnwid,height=self.btnhei)
        self.btn9.place(x=self.btnwid*2,y=self.btnhei*2+self.btnhei,width=self.btnwid,height=self.btnhei)
        self.btnEtr.place(x=self.btnwid*3,y=self.btnhei*2+self.btnhei,width=self.btnwid,height=self.btnhei)
