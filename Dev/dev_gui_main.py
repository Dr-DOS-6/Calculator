...
class func:
    def screenresetter(self,mode):
        ...
        if mode == 1:
            ...
            self.btnClr =  tk.Button(self.main_win,text=f"{self.langset[3]}",command=lambda: self.btnClear())
            self.btnExt =  tk.Button(self.main_win,text=f'{self.langset[4]}',command=lambda: self.btnExit())
            self.console = tk.Label(self.main_win,relief="sunken",anchor=tk.NW,textvariable=self.textoutput)
...
class main_win(func):
    def __init__(self):
        ...
        self.temp = str()
        mli[2] = 0
        self.conframe = tk.Frame(self.main_win,relief=tk.RAISED,bd=2)#,height=10)#self.btnhei*4)
        self.btnframe1 = tk.Frame(self.main_win,relief=tk.RAISED,bd=2, width=self.btnwid*4,height=self.btnhei)
        self.btnframe2 = tk.Frame(self.main_win)
        self.btnframe3 = tk.Frame(self.main_win)
        self.btnframe4 = tk.Frame(self.main_win)
        self.btnframe5 = tk.Frame(self.main_win)
        self.btn0 =    tk.Button(self.main_win, text="0")
        self.btn1 =    tk.Button(self.main_win, text="1",command=lambda: self.btnAdd('1'))
        self.btn2 =    tk.Button(self.main_win, text="2",command=lambda: self.btnAdd('2'))
        self.btn3 =    tk.Button(self.main_win, text="3")
        self.btn4 =    tk.Button(self.main_win, text="4")
        self.btn5 =    tk.Button(self.main_win, text="5")
        self.btn6 =    tk.Button(self.main_win, text="6")
        self.btn7 =    tk.Button(self.main_win, text="7")
        self.btn8 =    tk.Button(self.main_win, text="8")
        self.btn9 =    tk.Button(self.main_win, text="9")
        self.btnPe =   tk.Button(self.main_win, text=".")
        self.btnPl =   tk.Button(self.main_win, text="+")
        self.btnMin =  tk.Button(self.main_win, text="-")
        self.btnAst =  tk.Button(self.btnframe1,width=self.btnwid,text="x")
        self.btnSl =   tk.Button(self.btnframe1,width=self.btnwid,text="÷")
        self.btnFn =   tk.Button(self.btnframe1,width=self.btnwid,text=f"切替")   
        self.btnBksp = tk.Button(self.btnframe1,width=self.btnwid,text="←")
        self.btnEtr =  tk.Button(self.main_win, text="Enter",command=lambda: self.btnEnter())
        self.btnClr =  tk.Button(self.main_win,text=f"消去/\n出力")
        self.btnExt =  tk.Button(self.main_win,text=f'終了/\nモード切替',command=lambda: self.btnExit())
        self.console = tk.Label(self.conframe,relief="sunken",anchor=tk.NW,textvariable=self.textoutput)
        self.conframe.pack(fill='x',side=tk.TOP,expand=0)
        self.console.pack(fill='x',expand=1)#place(x=0,y=0,width=self.btnwid*4,height=self.btnhei*2)
        self.btnframe1.pack(fill='x',side=tk.TOP,expand=0)
        self.btnFn.grid(column=0,row=0)#lace(x=0,y=self.btnhei*2,width=self.btnwid,height=self.btnhei)
        self.btnSl.grid(column=1,row=0)#lace(x=self.btnwid,y=self.btnhei*2,width=self.btnwid,height=self.btnhei)
        self.btnAst.grid(column=2,row=0)#lace(x=self.btnwid*2,y=self.btnhei*2,width=self.btnwid,height=self.btnhei)
        self.btnBksp.grid(column=3,row=0)#lace(x=self.btnwid*3,y=self.btnhei*2,width=self.btnwid,height=self.btnhei)
        self.btn7.place(x=0,y=self.btnhei*2+self.btnhei,width=self.btnwid,height=self.btnhei)
        self.btn8.place(x=self.btnwid,y=self.btnhei*2+self.btnhei,width=self.btnwid,height=self.btnhei)
        self.btn9.place(x=self.btnwid*2,y=self.btnhei*2+self.btnhei,width=self.btnwid,height=self.btnhei)
        self.btnEtr.place(x=self.btnwid*3,y=self.btnhei*2+self.btnhei,width=self.btnwid,height=self.btnhei)
