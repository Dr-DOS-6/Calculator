...
class main_win(func):
    def __init__(self):
        ...
        self.btnframe2 = ttk.Frame(self.main_win)
        self.btnframe3 = ttk.Frame(self.main_win)
        self.btnframe4 = ttk.Frame(self.main_win)
        self.btnframe5 = ttk.Frame(self.main_win)
        ...
        self.btnAst =  ttk.Button(self.btnframe1,width=3,text="x",style="stdButton.TButton")
        self.btnSl =   ttk.Button(self.btnframe1,width=3,text="÷",style="stdButton.TButton")
        self.btnFn =   ttk.Button(self.btnframe1,width=3,text=f"切替",style="stdButton.TButton")   
        self.btnBksp = ttk.Button(self.btnframe1,width=3,text="←",style="stdButton.TButton")
        self.btnEtr =  ttk.Button(self.main_win, text="Enter",style="stdButton.TButton",command=lambda: self.btnEnter())
