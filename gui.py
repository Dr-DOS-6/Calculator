...
buttonnmlk = tk.Button(main_frm, text="Fn", height=4, width=10)
buttonrst =  tk.Button(main_frm,text="Reset",height=4,width=10)
buttonbksp = tk.Button(main_frm,text="Bksp/Del",height=4,width=10)
console =    tk.Label(main_frm,text='ここにコンソールを表示',height=9,width=38,borderwidth=3,relief="sunken",font=('Meiryo',10))
console.grid(column=0,row=0,columnspan=4,rowspan=2)
buttonnmlk.grid(column=0,row=2)
